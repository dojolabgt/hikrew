...
function compileShader(gl: WebGL2RenderingContext, type: number, source: string, keywords: string[] | null = null): WebGLShader | null {
...
function createProgram(gl: WebGL2RenderingContext, vertexShader: WebGLShader | null, fragmentShader: WebGLShader | null): WebGLProgram | null {
...
class Material {
  ...
  constructor(gl: WebGL2RenderingContext, vertexShader: WebGLShader | null, fragmentShaderSource: string) {
    this.gl = gl;
...
class Program {
  ...
  constructor(gl: WebGL2RenderingContext, vertexShader: WebGLShader | null, fragmentShader: WebGLShader | null) {
    this.gl = gl;
...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      const colors = [
        { r: 0xa8 / 255, g: 0xc0 / 255, b: 0xff / 255 }, // #a8c0ff - Azul claro
        { r: 0x3f / 255, g: 0x2b / 255, b: 0x96 / 255 }, // #3f2b96 - Púrpura oscuro
        { r: 0xc4 / 255, g: 0x71 / 255, b: 0xf5 / 255 }  // #c471f5 - Púrpura brillante
      ];
      const selectedColor = colors[Math.floor(Math.random() * colors.length)];
      const variation = 0.8 + Math.random() * 0.4;
      return {
        r: selectedColor.r * variation * 0.4,
        g: selectedColor.g * variation * 0.4,
        b: selectedColor.b * variation * 0.4
      };
    }
