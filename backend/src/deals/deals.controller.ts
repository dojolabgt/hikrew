...
export class DealsController {
    ...
    updateQuotation(
        ...
        return this.dealsService.updateQuotation(workspaceId, dealId, quotationId, dto);
    }
    ...
    updateItem(
        ...
        return this.dealsService.updateItem(workspaceId, dealId, quotationId, itemId, dto);
    }
    ...
    deleteItem(
        ...
        return this.dealsService.deleteItem(workspaceId, dealId, quotationId, itemId);
    }
    ...
    createOrUpdatePaymentPlan(
        ...
        return this.dealsService.createOrUpdatePaymentPlan(workspaceId, dealId, dto);
    }
    ...
    updateMilestone(
        ...
        return this.dealsService.updateMilestone(workspaceId, dealId, milestoneId, dto);
    }
