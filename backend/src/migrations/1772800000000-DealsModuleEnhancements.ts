...
export class DealsModuleEnhancements1772800000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "deals" ADD "currentStep" character varying DEFAULT 'brief'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "quotation_items" ADD "unitType" "public"."quotation_items_unittype_enum" DEFAULT 'UNIT'`,
    );
    await queryRunner.query(
      `ALTER TABLE "quotation_items" ADD "internalCost" numeric(12,2) NOT NULL DEFAULT '0'`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "quotation_items" DROP COLUMN "internalCost"`,
    );
    await queryRunner.query(
      `ALTER TABLE "quotation_items" DROP COLUMN "unitType"`,
    );
    await queryRunner.query(
