...
export class AddCurrencyToQuotation1773103949010 implements MigrationInterface {
    name = 'AddCurrencyToQuotation1773103949010'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "quotations" ADD "currency" character varying(10)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "quotations" DROP COLUMN "currency"`);
    }
