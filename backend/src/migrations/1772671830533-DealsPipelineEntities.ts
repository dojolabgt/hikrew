...
export class DealsPipelineEntities1772671830533 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_milestones_status_enum" AS ENUM('PENDING', 'PAID', 'OVERDUE', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."deals_status_enum" AS ENUM('DRAFT', 'SENT', 'VIEWED', 'NEGOTIATING', 'WON', 'LOST')`);
        ...
        await queryRunner.query(`ALTER TABLE "brief_templates" ADD CONSTRAINT "FK_1dd219de694f443ea5134de73ba" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "briefs" ADD CONSTRAINT "FK_5f9b244e3e67b330e2de093ac7d" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "briefs" ADD CONSTRAINT "FK_69420cf4371d66d7bf6a197501e" FOREIGN KEY ("template_id") REFERENCES "brief_templates"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_milestones" ADD CONSTRAINT "FK_247547ae48ca3eedb0e4e59a688" FOREIGN KEY ("payment_plan_id") REFERENCES "payment_plans"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_plans" ADD CONSTRAINT "FK_b45dd997f8d3b69e3f25c2e7bc9" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_plans" ADD CONSTRAINT "FK_f3f96fee44b50d848c165ea018c" FOREIGN KEY ("quotation_id") REFERENCES "quotations"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "deals" ADD CONSTRAINT "FK_6d0696dcb275b1754e3fc60bee8" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "deals" ADD CONSTRAINT "FK_7a1770366da1de36b1efc628073" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "quotations" ADD CONSTRAINT "FK_fab024a65dc86a463a1d042ea73" FOREIGN KEY ("deal_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "quotations" DROP CONSTRAINT "FK_fab024a65dc86a463a1d042ea73"`);
        ...
        await queryRunner.query(`ALTER TABLE "deals" DROP CONSTRAINT "FK_6d0696dcb275b1754e3fc60bee8"`);
        await queryRunner.query(`ALTER TABLE "payment_plans" DROP CONSTRAINT "FK_f3f96fee44b50d848c165ea018c"`);
        await queryRunner.query(`ALTER TABLE "payment_plans" DROP CONSTRAINT "FK_b45dd997f8d3b69e3f25c2e7bc9"`);
        await queryRunner.query(`ALTER TABLE "payment_milestones" DROP CONSTRAINT "FK_247547ae48ca3eedb0e4e59a688"`);
        await queryRunner.query(`ALTER TABLE "briefs" DROP CONSTRAINT "FK_69420cf4371d66d7bf6a197501e"`);
        await queryRunner.query(`ALTER TABLE "briefs" DROP CONSTRAINT "FK_5f9b244e3e67b330e2de093ac7d"`);
        await queryRunner.query(`ALTER TABLE "brief_templates" DROP CONSTRAINT "FK_1dd219de694f443ea5134de73ba"`);
