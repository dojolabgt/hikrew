...
export class AddRobustProposalFields1773100619601 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "workspaces" ADD "default_proposal_terms" text`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "deals" ADD "validUntil" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "workspaces" DROP COLUMN "default_proposal_terms"`,
    );
  }
}
