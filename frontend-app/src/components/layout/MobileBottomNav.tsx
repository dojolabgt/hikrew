    ...
    return (
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
                <div className="bg-white/95 dark:bg-gray-950/95 backdrop-blur-xl border-t border-gray-100/80 dark:border-gray-800/40">
                            ...
                            if (item === null) {
                                return (
                                    <button
                                        ...
                                        className="relative -translate-y-5 flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-700 shadow-lg shadow-indigo-500/30 active:scale-95 transition-transform duration-150"
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <item.icon className={cn(
                                        ...
                                        active
                                            ? 'text-indigo-600 dark:text-indigo-400 stroke-[2.5px]'
                                            : 'text-gray-400 dark:text-gray-500 stroke-[1.5px]'
                                    )} />
                                    <span className={cn(
            ...
            <div
                className={cn(
                    'fixed inset-0 z-[60] md:hidden bg-gray-900/50 backdrop-blur-sm',
            ...
            <div className={cn(
                ...
                <div className="flex justify-center pt-3 pb-1 shrink-0">
                    <div className="w-10 h-[3px] rounded-full bg-gray-200 dark:bg-gray-700" />
                </div>
                ...
                <div className="flex items-center justify-between px-5 pt-2 pb-3 shrink-0">
                    <div>
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Hi Krew</p>
                    </div>
                    <button
                        onClick={() => setSheetOpen(false)}
                        className="p-2 rounded-xl text-gray-500 bg-gray-100/80 hover:bg-gray-200 dark:text-gray-400 dark:bg-white/5 dark:hover:bg-white/10 transition-all duration-200"
                        aria-label="Cerrar"
                    >
                        <X className="h-4 w-4" />
                    </button>
                                        ...
                                        <Link
                                            ...
                                            className={cn(
                                                ...
                                                active
                                                    ...
                                                    : 'text-gray-500 dark:text-gray-400 font-medium hover:bg-white/60 dark:hover:bg-white/5'
                                            )}
                                        >
                                            <item.icon className={cn(
                ...
                {/* User footer */}
                <div className="shrink-0 border-t border-gray-100/80 dark:border-gray-800/40 px-4 pt-3 pb-10">
                    <div className="flex items-center gap-3 px-3 py-3 rounded-2xl bg-white/60 dark:bg-white/5">
                        <Avatar className="h-9 w-9 ring-1 ring-gray-200 dark:ring-gray-700 shrink-0">
                            <AvatarImage src={getImageUrl(user?.profileImage)} alt={userFullName} className="object-cover" />
                            <AvatarFallback className="bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-300 font-bold text-sm uppercase">
                                {userInitial}
                            </AvatarFallback>
                        </Avatar>
